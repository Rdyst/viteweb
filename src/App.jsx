...
const devteam = <div class="devkon">
  ...
  <div className="devteam" id="devteam">
    ...
    <img class="gulagdev pfp" id="gulag" src={gulag} onClick={() => popiszmena("negr","negr","negr","negr","zobrazenapfp","negr","devcss adambg anim","","Gulag A.K.A Adam<br><br>- Goblin <br><br> - Interface <br><br> - Lazy <br> <a href=https://github.com/AdamBalcarCZ target=_blank ><img class=githubicon src=https://pngimg.com/uploads/github/github_PNG58.png></a>","adamp","adambgcolor")}  />
