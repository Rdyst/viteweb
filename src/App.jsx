...
const devteam = <div class="devkon">
  ...
  <div className="devteam" id="devteam">
    ...
    <img class="sasadev pfp" id="sasa" src={sasa} onClick={() => popiszmena("zobrazenapfp","negr","negr","negr","negr","negr","devcss sasabg anim",'" Neni to prd ,je to sračka" - sasa',"Rdyst A.K.A sasa<br><br>- Web Creator <br><br> - Main Web Programmer <br><br> - Vite <br><br><br><br><br><br><br><br><br><br> <a href=https://github.com/Rdyst target=_blank ><img class=githubicon src=https://pngimg.com/uploads/github/github_PNG58.png><a href=https://steamcommunity.com/id/Rdyst target=_blank ><img class=steamicon src=https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Steam_icon_logo.svg/512px-Steam_icon_logo.svg.png /> </a>","sasap","sasabgcolor","sasapopis") } />
    <img class="pepadev pfp" id="pepa" src={pepa} onClick={() => popiszmena("negr","zobrazenapfp pepazobrazena","negr","negr","negr","negr","devcss pepabg anim",'"I hate life" *keeps living* - Pepa Floydsky',"AshMane <br> A.K.A Pepa Floydsky <br><br> - CEO of Napicu <br><br> - Main Programmer <br><br> - Unreal Engine 5 <br><br><br><br><br><br><a href=https://steamcommunity.com/id/XXXMETANIGHT target=_blank ><img class=steamicon src=https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Steam_icon_logo.svg/512px-Steam_icon_logo.svg.png /> <a>","pepap","pepabgcolor","pepapopis")}  />
